...
1. Search for "WP 3D Motion Slider"
1. Click 'Install'
...
1. Upload the `wp-3d-motion-slider` folder to the `/wp-content/plugins/` directory
1. Activate the `wp-3d-motion-slider` plugin through the 'Plugins' menu in WordPress
...
`<?php echo do_shortcode('[wp3d-slider]'); ?>`
